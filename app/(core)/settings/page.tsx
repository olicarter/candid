...
import InvitePersonDialogContent from './InvitePersonDialogContent'
import UpdateBillingDialogContent from './UpdateBillingDialogContent'
import UpdateProfileDialogContent from './UpdateProfileDialogContent'
...
export default async function TeamPage() {
  ...
  const { data: profile, error: getProfileError } = await supabase
    .from('profiles')
    .select(
      '*, members:organizations_members!organizations_members_profile_fkey(*, organization(*, members:organizations_members(profile(*))))',
    )
    .eq('id', user.id)
    .single()

  if (getProfileError) {
    console.error('settings page getProfileError')
