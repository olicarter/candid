...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-md bg-orange-100 text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    className="flex h-12 items-center border-b border-orange-950/10 px-3"
    cmdk-input-wrapper=""
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-12 w-full rounded-md bg-transparent py-3 outline-none placeholder:text-orange-950/50 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-orange-950/50',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default h-12 select-none items-center rounded-sm px-2 outline-none aria-selected:bg-orange-200 aria-selected:text-orange-900 data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 dark:aria-selected:bg-orange-800 dark:aria-selected:text-orange-50',
      className,
    )}
    {...props}
  />
